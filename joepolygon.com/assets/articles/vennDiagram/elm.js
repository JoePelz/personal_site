...
Elm.Boolean2D = Elm.Boolean2D || {};
Elm.Boolean2D.make = function (_elm) {
   "use strict";
   _elm.Boolean2D = _elm.Boolean2D || {};
   if (_elm.Boolean2D.values)
   return _elm.Boolean2D.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
   $moduleName = "Boolean2D",
   $Basics = Elm.Basics.make(_elm),
   ...
   $JPCommon = Elm.JPCommon.make(_elm),
   $List = Elm.List.make(_elm),
   $Signal = Elm.Signal.make(_elm),
   $String = Elm.String.make(_elm),
   $Venn2 = Elm.Venn2.make(_elm),
   $Venn3 = Elm.Venn3.make(_elm),
   $Venn4 = Elm.Venn4.make(_elm),
   $Window = Elm.Window.make(_elm);
   var getAllRegions = _L.fromArray(["Abcd"
                                    ,"Bacd"
                                    ,"Cabd"
                                    ,"Dabc"
                                    ,"ABcd"
      ...
      return function () {
         ...
         {case "A":
            ...
            return _L.fromArray([false
                                ...
                                ,true]);
            case "a":
            return invertOp(getRegion(_U.chr("A")));
            case "b":
            return invertOp(getRegion(_U.chr("B")));
            case "c":
            return invertOp(getRegion(_U.chr("C")));
            case "d":
            return invertOp(getRegion(_U.chr("D")));
            case "u":
            return invertOp(getRegion(_U.chr("U")));}
         return _L.fromArray([false
                             ,false
                             ,false
                             ,false
   ...
   var swapCase = function (c) {
      return _U.eq($Char.toLower(c),
      c) ? $Char.toUpper(c) : $Char.toLower(c);
   };
   var symDiffOp = F2(function (lhs,
   rhs) {
      return A3($List.map2,
      F2(function (l,r) {
         return l && $Basics.not(r) || r && $Basics.not(l);
      }),
      lhs,
      rhs);
   });
   var diffOp = F2(function (lhs,
   rhs) {
      return A3($List.map2,
      F2(function (l,r) {
         return l && $Basics.not(r);
      }),
      lhs,
      rhs);
   });
   var intersectionOp = F2(function (lhs,
   rhs) {
      return A3($List.map2,
      F2(function (l,r) {
         return l && r;
   ...
   var getNextOp = F2(function (precedence,
   f) {
      return function () {
         switch (f.ctor)
         {case "::": switch (f._0 + "")
              {case "(": return function () {
                      var $ = A2(getNextOp,1,f._1),
                      op = $._0,
                      rest = $._1;
                      return A3(parseFormulaHelper,
                      1,
                      rest,
                      op);
                   }();}
              ...
              {case "::":
                 switch (f._1._0 + "")
                   {case "\'": return A2(getNextOp,
                        precedence,
                        A2($List._op["::"],
                        swapCase(f._0),
                        f._1._1));
                      case "*":
                      return _U.cmp(precedence,
                        2) < 0 ? A3(parseFormulaHelper,
                        2,
                        A2($List._op["::"],
                        _U.chr("*"),
                        f._1._1),
                        getRegion(f._0)) : {ctor: "_Tuple2"
                                           ,_0: getRegion(f._0)
                                           ,_1: A2($List._op["::"],
                                           _U.chr("*"),
                                           f._1._1)};
            ...
            return {ctor: "_Tuple2"
                   ...
                   ,_1: _L.fromArray([])};}
         _U.badCase($moduleName,
         "between lines 136 and 148");
      }();
   });
   var parseFormulaHelper = F3(function (precedence,
   f,
   sofar) {
      return function () {
         switch (f.ctor)
         {case "::": switch (f._0 + "")
              {case "\'": return function () {
                 ...
                 return {ctor: "_Tuple2"
                        ...
                        ,_1: f._1};
                 case "*": return function () {
                      var $ = A2(getNextOp,2,f._1),
                      op = $._0,
                      rest = $._1;
                      var result = A2(intersectionOp,
                      sofar,
                      op);
                      return A3(parseFormulaHelper,
                      precedence,
            ...
            return {ctor: "_Tuple2"
                   ...
                   ,_1: _L.fromArray([])};}
         return {ctor: "_Tuple2"
                ,_0: _L.fromArray([true])
                ,_1: _L.fromArray([])};
      }();
   });
   var dropSpaces = function (chars) {
   ...
   var parseFormula = function (f) {
      return function () {
         var spaceless = dropSpaces(f);
         var $ = A2(getNextOp,
         1,
         spaceless),
         op = $._0,
         rest = $._1;
         var $ = A3(parseFormulaHelper,
         1,
         rest,
         op),
         result = $._0,
      ...
      return function () {
         ...
         {case "Activate":
            ...
            switch (action._0.ctor)
              {case "_Tuple2":
                 return function () {
                      var dim = A2($Basics.min,
                      action._0._0,
                      action._0._1);
                      var newDiagram4 = A2($Venn4.update,
                      $Venn4.Resize({ctor: "_Tuple2"
                                    ,_0: dim
                                    ,_1: dim}),
                      model.diagram4);
                      var newDiagram3 = A2($Venn3.update,
                      $Venn3.Resize({ctor: "_Tuple2"
                                    ,_0: dim
                                    ,_1: dim}),
                      model.diagram3);
                      var newDiagram2 = A2($Venn2.update,
                      $Venn2.Resize({ctor: "_Tuple2"
                                    ,_0: dim
                                    ,_1: dim}),
                      model.diagram2);
                      return _U.replace([["diagram4"
                                         ,newDiagram4]
                                        ,["diagram3",newDiagram3]
                                        ,["diagram2",newDiagram2]
                                        ,["window"
                                         ,{ctor: "_Tuple2"
                                          ,_0: action._0._0
                                          ,_1: action._0._1}]],
            ...
            case "Update":
            return function () {
                 var oldDiagram2 = model.diagram2;
                 var oldDiagram3 = model.diagram3;
                 var oldDiagram4 = model.diagram4;
                 var equation = $String.toUpper(action._0.string);
                 var newFormula = _U.replace([["string"
                                              ,equation]],
                 action._0);
                 var regions = parseFormula($String.toList(equation));
                 var adjustedRegions = A3($List.foldr,
                 F2(function (_v15,old) {
                    return function () {
                       switch (_v15.ctor)
                       {case "_Tuple2":
                          return _v15._0 ? A2($List._op["::"],
                            _v15._1,
                            old) : old;}
                       _U.badCase($moduleName,
                       "on line 112, column 62 to 87");
                    }();
                 }),
                 _L.fromArray([]),
                 A3($List.map2,
                 ...
                 regions,
                 getAllRegions));
                 var newDiagram4 = _U.replace([["equation"
                                               ,adjustedRegions]],
                 oldDiagram4);
                 var newDiagram3 = _U.replace([["equation"
                                               ,adjustedRegions]],
                 oldDiagram3);
                 var newDiagram2 = _U.replace([["equation"
                                               ,adjustedRegions]],
                 oldDiagram2);
                 return _U.replace([["formula"
                                    ,newFormula]
                                   ,["diagram4",newDiagram4]
                                   ,["diagram3",newDiagram3]
                                   ,["diagram2",newDiagram2]],
                 model);
              }();}
         _U.badCase($moduleName,
         "between lines 93 and 122");
      }();
   });
   ...
   var NoOp = {ctor: "NoOp"};
   var updateMailbox = $Signal.mailbox(NoOp);
   ...
   name) {
      ...
      _L.fromArray([A2($Html.input,
                   _L.fromArray([$Html$Attributes.type$("radio")
                                ,$Html$Attributes.checked(_U.eq(model.activeForm,
                                name))
                                ,A3($Html$Events.on,
                                "change",
         ...
         {case "_Tuple2":
            return A2($Graphics$Element.flow,
              ...
              _L.fromArray([A2($Graphics$Element.spacer,
                           ...
                           _v21._0,
                           _v21._0 / 10 | 0,
                           $Graphics$Element.middle)($Graphics$Element.width(_v21._0 / 2 | 0)($Graphics$Element.height(_v21._0 / 13 | 0)(A4($Graphics$Input$Field.field,
                           $JPCommon.inputStyleSized(_v21._0 / 20 | 0),
                           function (content) {
                              return A2($Signal.message,
                           ...
                           "A",
                           model.formula))))
                           ,_U.eq(model.activeForm,
                           "Venn 4") ? A2($Venn4.view,
                           {ctor: "_Tuple2"
                           ,_0: _v21._0
                           ,_1: _v21._0},
                           model.diagram4) : _U.eq(model.activeForm,
                           "Venn 3") ? A2($Venn3.view,
                           {ctor: "_Tuple2"
                           ,_0: _v21._0
                           ,_1: _v21._0},
                           model.diagram3) : _U.eq(model.activeForm,
                           "Venn 2") ? A2($Venn2.view,
                           {ctor: "_Tuple2"
                           ,_0: _v21._0
                           ,_1: _v21._0},
                           model.diagram2) : A2($Venn3.view,
                           {ctor: "_Tuple2"
                           ,_0: _v21._0
                           ,_1: _v21._0},
                           model.diagram3)
                           ...
                           _L.fromArray([A2($Html.toElement,
                                        100,
                                        50)(A4(radio,
                                        updateMailbox.address,
                                        model,
                                        ...
                                        "Venn 2"))]))]));}
         _U.badCase($moduleName,
         "between lines 54 and 73");
      }();
   });
   var init = F2(function (w,h) {
      return {_: {}
             ,activeForm: "Venn 3"
             ,diagram2: A2($Venn2.init,w,w)
             ,diagram3: A2($Venn3.init,w,w)
             ,diagram4: A2($Venn4.init,w,w)
             ,formula: $Graphics$Input$Field.noContent
             ,isValid: true
             ,mpos: {ctor: "_Tuple2"
                    ,_0: 0
                    ,_1: 0}
   ...
   _elm.Boolean2D.values = {_op: _op
                           ...
                           ,getNextOp: getNextOp
                           ,parseFormulaHelper: parseFormulaHelper
                           ,unionOp: unionOp
                           ,intersectionOp: intersectionOp
                           ,diffOp: diffOp
                           ,symDiffOp: symDiffOp
                           ,swapCase: swapCase
                           ,invertOp: invertOp
...
Elm.JPCommon = Elm.JPCommon || {};
Elm.JPCommon.make = function (_elm) {
   "use strict";
   _elm.JPCommon = _elm.JPCommon || {};
   if (_elm.JPCommon.values)
   return _elm.JPCommon.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
   ...
   var codeStyleThin = {_: {}
                       ...
                       ,italic: false
                       ,line: $Maybe.Nothing
                       ,typeface: _L.fromArray(["Consolas"
                                               ,"Courier New"
                                               ,"sans serif"])};
   var codeStyleSized = function (z) {
      return {_: {}
             ,bold: true
             ,color: $Color.black
             ,height: $Maybe.Just(z)
   ...
   var codeStyle = {_: {}
                   ...
                   ,typeface: _L.fromArray(["Consolas"
                                           ,"Courier New"
                                           ,"sans serif"])};
   var inputStyleSized = function (z) {
      return {_: {}
             ,highlight: {_: {}
                         ,color: $Color.blue
                         ,width: 1}
             ,outline: {_: {}
                       ...
                       ,radius: z / 4 | 0
                       ,width: $Graphics$Input$Field.uniformly(z / 16 | 0)}
             ,padding: $Graphics$Input$Field.uniformly(z / 8 | 0)
             ,style: codeStyleSized($Basics.toFloat(z))};
   };
   var inputStyle = {_: {}
                    ,highlight: {_: {}
                                ,color: $Color.blue
                    ...
                    ,padding: $Graphics$Input$Field.uniformly(2)
                    ,style: codeStyle};
   var tableSpace = A2($Graphics$Element.spacer,
   10,
   10);
   var subtitleHeight = 50;
   var titleHeight = 75;
   var lineHeight = 25;
   var viewTableRow = F2(function (caption,
   value) {
      return A2($Graphics$Element.flow,
      $Graphics$Element.right,
      _L.fromArray([A3($Graphics$Element.container,
                   180,
                   lineHeight,
                   $Graphics$Element.midRight)($Graphics$Element.leftAligned($Text.fromString(caption)))
                   ,tableSpace
                   ,A3($Graphics$Element.container,
                   320,
                   lineHeight,
                   $Graphics$Element.midLeft)($Graphics$Element.leftAligned($Text.style(codeStyle)($Text.fromString(value))))]));
   });
   var viewTableElement = F2(function (caption,
   elem) {
      return A2($Graphics$Element.flow,
      $Graphics$Element.right,
      _L.fromArray([A3($Graphics$Element.container,
   ...
   _elm.JPCommon.values = {_op: _op
                          ,lineHeight: lineHeight
                          ,titleHeight: titleHeight
                          ,subtitleHeight: subtitleHeight
                          ,tableSpace: tableSpace
                          ,inputStyle: inputStyle
                          ,inputStyleSized: inputStyleSized
                          ,codeStyle: codeStyle
                          ,codeStyleSized: codeStyleSized
                          ,codeStyleThin: codeStyleThin
                          ,titleStyle: titleStyle
                          ,subtitleStyle: subtitleStyle
                          ,viewTableRow: viewTableRow
                          ,viewTableElement: viewTableElement};
   return _elm.JPCommon.values;
};
Elm.Json = Elm.Json || {};
...
Elm.Venn2 = Elm.Venn2 || {};
Elm.Venn2.make = function (_elm) {
   "use strict";
   _elm.Venn2 = _elm.Venn2 || {};
   if (_elm.Venn2.values)
   return _elm.Venn2.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
   ...
   $String = Elm.String.make(_elm),
   $Text = Elm.Text.make(_elm),
   $VennBuilder = Elm.VennBuilder.make(_elm),
   $Window = Elm.Window.make(_elm);
   var NoOp = {ctor: "NoOp"};
   var updateMailbox = $Signal.mailbox(NoOp);
   var Update = function (a) {
   ...
   $Mouse.position)),
   updateMailbox.signal);
   var conformRegions = function (s) {
      return function () {
         var testB = A2($String.contains,
         "B",
         s) ? _U.chr("B") : _U.chr("b");
         var testA = A2($String.contains,
         "A",
         s) ? _U.chr("A") : _U.chr("a");
         return $String.fromList($List.sort(_L.fromArray([testA
                                                         ,testB])));
      }();
   };
   var labelStyle = {_: {}
   ...
   model) {
      return function () {
         ...
         {case "_Tuple2":
            return function () {
                 var validNames = A2($List.map,
                 conformRegions,
                 model.equation);
                 var activeRegions = A2($List.filter,
                 function (_v4) {
                    return function () {
                       switch (_v4.ctor)
                       {case "_Tuple2":
                          return A2($List.any,
                            function (n) {
                               return _U.eq(_v4._0,n);
                            },
                            validNames);}
                       _U.badCase($moduleName,
                       "on line 89, column 49 to 81");
                    }();
                 },
                 model.regions);
                 return A2($Graphics$Element.flow,
                 ...
                 _v0._1,
                 A2($Basics._op["++"],
                 _L.fromArray([$Graphics$Collage.filled(A2($List.any,
                              function (n) {
                                 return _U.eq("U",n);
                              },
                              model.equation) ? $Color.lightOrange : $Color.darkBlue)(A2($Graphics$Collage.rect,
                              $Basics.toFloat(_v0._0),
                              $Basics.toFloat(_v0._1)))
                              ,$Graphics$Collage.filled($Color.darkBlue)($Graphics$Collage.polygon(model.cU))]),
                 A2($Basics._op["++"],
                 A2($List.map,
                 function (val) {
                    return $Graphics$Collage.filled($Color.lightOrange)($Graphics$Collage.polygon($Basics.snd(val)));
                 },
                 activeRegions),
                 A2($Basics._op["++"],
                 A2($List.map,
                 function (_v8) {
                    return function () {
                       switch (_v8.ctor)
                       {case "_Tuple2":
                          return $Graphics$Collage.move($VennBuilder.polyCenter(_v8._1))($Graphics$Collage.text($Text.style(_U.replace([["height"
                                                                                                                                        ,$Maybe.Just($Basics.toFloat(A2($Basics.min,
                                                                                                                                        _v0._0,
                                                                                                                                        _v0._1)) / 15)]],
                            labelStyle))($Text.fromString(A2($String.filter,
                            function (c) {
                               return _U.eq(c,
                               _U.chr("A")) || _U.eq(c,
                               _U.chr("B"));
                 ...
                 model.regions),
                 _L.fromArray([$Graphics$Collage.outlined($Graphics$Collage.solid($Color.black))($Graphics$Collage.polygon(model.cA))
                              ,$Graphics$Collage.outlined($Graphics$Collage.solid($Color.black))($Graphics$Collage.polygon(model.cB))])))))]));
              }();}
         _U.badCase($moduleName,
         "between lines 88 and 117");
      }();
   });
   var mouseToShapeSpace = F2(function (window,
   _v12) {
      return function () {
         switch (_v12.ctor)
         {case "_Tuple2":
            return {ctor: "_Tuple2"
                   ,_0: _v12._0 - $Basics.toFloat(window.width / 2 | 0)
                   ,_1: _v12._1 * -1 + $Basics.toFloat(window.height / 2 | 0)};}
         _U.badCase($moduleName,
         "on line 75, column 36 to 102");
      }();
   });
   var stringToPoly = F3(function (cA,
   cB,
   s) {
      return A3($String.foldl,
      F2(function (newC,oldVal) {
         return _U.eq(oldVal,
         _L.fromArray([])) ? function () {
            ...
            switch (newC + "")
            {case "A":
               return A2($VennBuilder.intersectionPoly,
                 oldVal,
                 cA);
               case "B":
               return A2($VennBuilder.intersectionPoly,
                 ...
                 cB);
               case "a":
               return A2($VennBuilder.subtractionPoly,
                 oldVal,
                 cA);
               case "b":
               return A2($VennBuilder.subtractionPoly,
   ...
   var regionList = _L.fromArray(["Ab"
                                 ,"Ba"
                                 ,"AB"
                                 ,"U"]);
   var init = F2(function (w,h) {
      return function () {
         var radius = $Basics.toFloat(A2($Basics.min,
         w,
         h) / 4 | 0);
         var offset = radius / 2;
         var cA = $VennBuilder.offsetPoly({ctor: "_Tuple2"
                                          ,_0: 0 - offset
                                          ,_1: 0})($VennBuilder.circlePoints(radius));
         var cB = $VennBuilder.offsetPoly({ctor: "_Tuple2"
                                          ,_0: offset
                                          ,_1: 0})($VennBuilder.circlePoints(radius));
         var zones = A2($List.map,
         A2(stringToPoly,cA,cB),
         regionList);
         return {_: {}
                ,cA: cA
                ,cB: cB
                ,cU: A2($VennBuilder.unionPoly,
                cA,
                cB)
                ,dimensions: {_: {}
                             ,height: h
                             ,width: w}
                ,equation: _L.fromArray(["A"
                                        ,"B"
                                        ,"AB"])
                ,regions: A3($List.map2,
                F2(function (v0,v1) {
                   return {ctor: "_Tuple2"
                          ,_0: v0
                          ,_1: v1};
   ...
   _elm.Venn2.values = {_op: _op
                       ,Window: Window
                       ,Model: Model
                       ,regionList: regionList
                       ,init: init
                       ,stringToPoly: stringToPoly
                       ,mouseToShapeSpace: mouseToShapeSpace
                       ,labelStyle: labelStyle
                       ,view: view
                       ,conformRegions: conformRegions
                       ,Click: Click
                       ,Resize: Resize
                       ,Update: Update
                       ,NoOp: NoOp
...
Elm.Venn3 = Elm.Venn3 || {};
Elm.Venn3.make = function (_elm) {
   "use strict";
   _elm.Venn3 = _elm.Venn3 || {};
   if (_elm.Venn3.values)
   return _elm.Venn3.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
      ...
      return function () {
         ...
         {case "_Tuple2":
            return function () {
                 ...
                 _L.fromArray([$Graphics$Collage.outlined($Graphics$Collage.solid($Color.black))($Graphics$Collage.polygon(model.cA))
                              ,$Graphics$Collage.outlined($Graphics$Collage.solid($Color.black))($Graphics$Collage.polygon(model.cB))
                              ,$Graphics$Collage.outlined($Graphics$Collage.solid($Color.black))($Graphics$Collage.polygon(model.cC))])))))]));
              }();}
         _U.badCase($moduleName,
         "between lines 94 and 126");
      }();
   });
   var mouseToShapeSpace = F2(function (window,
   _v12) {
      return function () {
         ...
         {case "_Tuple2":
            return {ctor: "_Tuple2"
                   ...
                   ,_1: _v12._1 * -1 + $Basics.toFloat(window.height / 2 | 0)};}
         _U.badCase($moduleName,
         "on line 81, column 36 to 102");
      }();
   });
   var stringToPoly = F4(function (cA,
   cB,
   cC,
   s) {
      return A3($String.foldl,
   ...
   var regionList = _L.fromArray(["Abc"
                                 ,"Bac"
                                 ,"Cab"
                                 ,"ABc"
                                 ,"BCa"
   ...
   var init = F2(function (w,h) {
      return function () {
         ...
         var cA = $VennBuilder.offsetPoly({ctor: "_Tuple2"
                                          ,_0: 0 - offset
                                          ,_1: offset})($VennBuilder.circlePoints(radius));
         var cB = $VennBuilder.offsetPoly({ctor: "_Tuple2"
                                          ,_0: offset
                                          ,_1: offset})($VennBuilder.circlePoints(radius));
         var cC = $VennBuilder.offsetPoly({ctor: "_Tuple2"
                                          ,_0: 0
                                          ,_1: 0 - offset})($VennBuilder.circlePoints(radius));
         var zones = A2($List.map,
         A3(stringToPoly,cA,cB,cC),
         regionList);
         return {_: {}
                ,cA: cA
                ,cB: cB
                ,cC: cC
                ,cU: $VennBuilder.unionPoly(cC)(A2($VennBuilder.unionPoly,
                cA,
                cB))
                ,dimensions: {_: {}
                             ,height: h
...
Elm.Venn4 = Elm.Venn4 || {};
Elm.Venn4.make = function (_elm) {
   "use strict";
   _elm.Venn4 = _elm.Venn4 || {};
   if (_elm.Venn4.values)
   return _elm.Venn4.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
         ...
         {case "_Tuple2":
            return function () {
                 ...
                 _L.fromArray([$Graphics$Collage.outlined($Graphics$Collage.solid($Color.black))($Graphics$Collage.polygon(model.cA))
                              ,$Graphics$Collage.outlined($Graphics$Collage.solid($Color.black))($Graphics$Collage.polygon(model.cB))
                              ,$Graphics$Collage.outlined($Graphics$Collage.solid($Color.black))($Graphics$Collage.polygon(model.cC))
                              ,$Graphics$Collage.outlined($Graphics$Collage.solid($Color.black))($Graphics$Collage.polygon(model.cD))])))))]));
              }();}
         _U.badCase($moduleName,
         "between lines 108 and 143");
      }();
   });
   var mouseToShapeSpace = F2(function (window,
   _v12) {
      return function () {
         ...
         {case "_Tuple2":
            return {ctor: "_Tuple2"
                   ...
                   ,_1: _v12._1 * -1 + $Basics.toFloat(window.height / 2 | 0)};}
         _U.badCase($moduleName,
         "on line 95, column 36 to 102");
      }();
   });
   var stringToPoly = F5(function (cA,
   cB,
   cC,
   cD,
   s) {
   ...
   var regionList = _L.fromArray(["Abcd"
                                 ,"Bacd"
                                 ,"Cabd"
                                 ,"Dabc"
                                 ,"ABcd"
   ...
   var init = F2(function (w,h) {
      return function () {
         ...
         h) / 4 | 0);
         var offset = radius / 2;
         var cD = $VennBuilder.offsetPoly({ctor: "_Tuple2"
                                          ,_0: 0
                                          ,_1: offset / 2})($VennBuilder.rotatePoly((0 - $Basics.pi) / 4)($VennBuilder.scalePoly({ctor: "_Tuple2"
                                                                                                                                 ,_0: 1.5
                                                                                                                                 ,_1: 0.9})($VennBuilder.circlePoints(radius))));
         var cC = $VennBuilder.offsetPoly({ctor: "_Tuple2"
                                          ,_0: 0
                                          ,_1: offset / 2})($VennBuilder.rotatePoly($Basics.pi / 4)($VennBuilder.scalePoly({ctor: "_Tuple2"
                                                                                                                           ,_0: 1.5
                                                                                                                           ,_1: 0.9})($VennBuilder.circlePoints(radius))));
         var cB = $VennBuilder.offsetPoly({ctor: "_Tuple2"
                                          ,_0: (0 - offset) * 1.4
                                          ,_1: 0 - offset})($VennBuilder.rotatePoly((0 - $Basics.pi) / 4)($VennBuilder.scalePoly({ctor: "_Tuple2"
                                                                                                                                 ,_0: 1.5
                                                                                                                                 ,_1: 0.9})($VennBuilder.circlePoints(radius))));
         var cA = $VennBuilder.offsetPoly({ctor: "_Tuple2"
                                          ,_0: offset * 1.4
                                          ,_1: 0 - offset})($VennBuilder.rotatePoly($Basics.pi / 4)($VennBuilder.scalePoly({ctor: "_Tuple2"
                                                                                                                           ,_0: 1.5
                                                                                                                           ,_1: 0.9})($VennBuilder.circlePoints(radius))));
         var zones = A2($List.map,
         A4(stringToPoly,cA,cB,cC,cD),
         regionList);
         return {_: {}
                ,cA: cA
                ,cB: cB
                ,cC: cC
                ,cD: cD
                ,cU: $VennBuilder.unionPoly(cD)($VennBuilder.unionPoly(cC)(A2($VennBuilder.unionPoly,
                cA,
                cB)))
                ,dimensions: {_: {}
                             ,height: h
...
Elm.VennBuilder = Elm.VennBuilder || {};
Elm.VennBuilder.make = function (_elm) {
   "use strict";
   _elm.VennBuilder = _elm.VennBuilder || {};
   if (_elm.VennBuilder.values)
   return _elm.VennBuilder.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
   $moduleName = "VennBuilder",
   $Basics = Elm.Basics.make(_elm),
   $List = Elm.List.make(_elm);
   var isInsideHelper = F2(function (points,
   _v0) {
      return function () {
         switch (_v0.ctor)
         {case "_Tuple2":
            return function () {
                 switch (points.ctor)
                 {case "::":
                    switch (points._0.ctor)
                      {case "_Tuple2":
                         switch (points._0._0.ctor)
                           {case "_Tuple2":
                              switch (points._0._1.ctor)
                                {case "_Tuple2":
                                   return !_U.eq(_U.cmp(points._0._0._1,
                                     _v0._1) > 0,
                                     _U.cmp(points._0._1._1,
                                     _v0._1) > 0) && _U.cmp(_v0._0,
                                     (points._0._1._0 - points._0._0._0) * (_v0._1 - points._0._0._1) / (points._0._1._1 - points._0._0._1) + points._0._0._0) < 0 ? $Basics.not(A2(isInsideHelper,
                                     points._1,
                                     {ctor: "_Tuple2"
                                     ,_0: _v0._0
                                     ,_1: _v0._1})) : A2(isInsideHelper,
                                     points._1,
                                     {ctor: "_Tuple2"
                                     ,_0: _v0._0
                                     ,_1: _v0._1});}
         ...
         {case "::":
            switch (poly._1.ctor)
              ...
              return function () {
                 ...
                 A2($Basics._op["++"],
                 poly._1,
                 _L.fromArray([poly._0])));
                 return A2(isInsideHelper,
                 shapePoints,
                 point);
              }();
            case "[]": return false;}
   ...
   var distanceBetweenSquared = F2(function (_v16,
   _v17) {
      return function () {
         switch (_v17.ctor)
         {case "_Tuple2":
            return function () {
                 switch (_v16.ctor)
                 {case "_Tuple2":
                    return Math.pow(_v17._0 - _v16._0,
                      2) + Math.pow(_v17._1 - _v16._1,
                      2);}
                 _U.badCase($moduleName,
                 "on line 24, column 45 to 65");
              }();}
         _U.badCase($moduleName,
         "on line 24, column 45 to 65");
      }();
   });
   var matchEndsHelper = F3(function (p1,
   p2,
   _v24) {
      return function () {
         switch (_v24.ctor)
         {case "_Tuple3":
            switch (_v24._2.ctor)
              {case "::": return function () {
                      var valNew = A2(distanceBetweenSquared,
                      p1,
                      p2);
                      var curNew = A2($Basics._op["++"],
                      _v24._2._1,
                      _L.fromArray([_v24._2._0]));
                      return _U.cmp(valNew,
                      _v24._0) < 0 ? {ctor: "_Tuple3"
                                     ,_0: valNew
                                     ,_1: curNew
                                     ,_2: curNew} : {ctor: "_Tuple3"
                                                    ,_0: _v24._0
                                                    ,_1: _v24._1
                                                    ,_2: curNew};
                   }();}
   ...
   var matchEnds = F2(function (a,
   b) {
      return function () {
         switch (a.ctor)
         {case "::": switch (a._1.ctor)
              {case "[]":
                 return A2($List._op["::"],
                   a._0,
                   b);}
   ...
   var reorderPoly = function (p) {
      return function () {
         switch (p.ctor)
         {case "::": switch (p._1.ctor)
              {case "[]":
                 return _L.fromArray([p._0]);}
              return A2($List._op["::"],
              p._0,
              reorderPoly(A2($List.sortBy,
              distanceBetweenSquared(p._0),
              p._1)));
            case "[]":
            return _L.fromArray([]);}
         _U.badCase($moduleName,
   ...
   var intersectionPoly = F2(function (a,
   b) {
      return function () {
         var bps = A2($List.filter,
         isInside(a),
         b);
         var aps = A2($List.filter,
         isInside(b),
         a);
         return reorderPoly(A2($Basics._op["++"],
         aps,
         bps));
      }();
   });
   var unionPoly = F2(function (a,
   b) {
      return function () {
         var bps = A2($List.filter,
         function ($) {
            return $Basics.not(isInside(a)($));
         },
         b);
         var aps = A2($List.filter,
         function ($) {
            return $Basics.not(isInside(b)($));
         },
         a);
         return reorderPoly(A2($Basics._op["++"],
         aps,
   ...
   var subtractionPoly = F2(function (a,
   b) {
      return function () {
         var bps = A2($List.filter,
         isInside(a),
   ...
   var rotatePoint = F2(function (theta,
   _v40) {
      return function () {
         switch (_v40.ctor)
         {case "_Tuple2":
            return function () {
                 var c = $Basics.cos(theta);
                 var s = $Basics.sin(theta);
                 return {ctor: "_Tuple2"
                        ,_0: _v40._0 * c - _v40._1 * s
                        ,_1: _v40._0 * s + _v40._1 * c};
              }();}
         _U.badCase($moduleName,
         "between lines 19 and 21");
      }();
   });
   var rotatePoly = F2(function (angle,
   points) {
      return A2($List.map,
      rotatePoint(angle),
      points);
   });
   var addPoint = F2(function (_v44,
   _v45) {
      return function () {
         switch (_v45.ctor)
         {case "_Tuple2":
            return function () {
                 ...
                 {case "_Tuple2":
                    return {ctor: "_Tuple2"
                           ...
                           ,_1: _v44._1 + _v45._1};}
                 _U.badCase($moduleName,
                 "on line 15, column 27 to 35");
              }();}
         _U.badCase($moduleName,
         "on line 15, column 27 to 35");
      }();
   });
   var polyCenter = function (poly) {
      return function () {
         var len = $Basics.toFloat($List.length(poly));
         var $ = A3($List.foldr,
         addPoint,
   ...
   var offsetPoly = F2(function (offset,
   points) {
      return A2($List.map,
      addPoint(offset),
      points);
   });
   var scalePoint = F2(function (_v52,
   _v53) {
      return function () {
         switch (_v53.ctor)
         {case "_Tuple2":
            return function () {
                 ...
                 {case "_Tuple2":
                    return {ctor: "_Tuple2"
                           ...
                           ,_1: _v53._1 * _v52._1};}
                 _U.badCase($moduleName,
                 "on line 12, column 29 to 37");
              }();}
         _U.badCase($moduleName,
         "on line 12, column 29 to 37");
      }();
   });
   var scalePoly = F2(function (multiplier,
   points) {
      return A2($List.map,
      scalePoint(multiplier),
      points);
   });
   var degToPos = function (radians) {
      return {ctor: "_Tuple2"
             ,_0: $Basics.cos(radians)
             ,_1: $Basics.sin(radians)};
   };
   var circlePoints = function (radius) {
      return function () {
         var numPoints = 62;
         return $List.map(function ($) {
            return scalePoint({ctor: "_Tuple2"
                              ,_0: radius
                              ,_1: radius})(degToPos($));
         })(A2($List.map,
         function (x) {
            return x / numPoints * 2 * $Basics.pi;
         },
         _L.range(1,numPoints)));
      }();
   };
   var ovalPoints = F2(function (width,
   height) {
      return function () {
         var numPoints = 60;
         return $List.map(function ($) {
   ...
   _elm.VennBuilder.values = {_op: _op
                             ,degToPos: degToPos
                             ,scalePoint: scalePoint
                             ,addPoint: addPoint
                             ,rotatePoint: rotatePoint
                             ,distanceBetweenSquared: distanceBetweenSquared
                             ...
                             ,isInside: isInside
                             ,isInsideHelper: isInsideHelper
                             ,matchEnds: matchEnds
                             ,matchEndsHelper: matchEndsHelper
                             ,reorderPoly: reorderPoly
                             ,intersectionPoly: intersectionPoly
                             ,unionPoly: unionPoly
                             ,subtractionPoly: subtractionPoly};
   return _elm.VennBuilder.values;
};
